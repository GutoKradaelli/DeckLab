...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-20 overflow-x-hidden">
      ...
      {/* --- HEADER --- */}
      <header className="sticky top-0 z-50 bg-clash-wood border-b-4 border-black shadow-clash-btn transition-all">
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-24 flex items-center justify-between">
          
          {/* Logo */}
          <div className="flex items-center gap-4 cursor-pointer group" onClick={() => setActiveTab('builder')}>
             <div className="relative">
                 <div className="w-16 h-16 rounded-2xl overflow-hidden border-2 border-clash-gold shadow-[0_0_15px_rgba(0,87,217,0.5)] bg-gradient-to-br from-clash-purple to-clash-purpleDark relative z-10 group-hover:scale-110 transition-all duration-300 ring-2 ring-black/20">
                     <div className="absolute inset-0 bg-clash-purple transform scale-[1.6] translate-y-2 translate-x-1 origin-top">
                        <img 
                            src="https://raw.githubusercontent.com/RoyaleAPI/cr-api-assets/master/cards/knight-ev1.png" 
                            alt="DeckLab Logo" 
                 ...
                 <div className="absolute -top-3 -right-3 text-clash-gold animate-bounce-sm z-20 drop-shadow-md"><Crown size={20} fill="currentColor" /></div>
             </div>
             <div className="flex flex-col justify-center">
                 <h1 className="text-3xl md:text-4xl font-display font-black tracking-tight text-white text-shadow-xl leading-[0.85] group-hover:tracking-normal transition-all duration-300">
                    Deck<span className="text-clash-blue drop-shadow-[0_2px_0_rgba(0,0,0,1)]">Lab</span>
                 </h1>
                 <span className="text-[11px] text-clash-parchment font-bold uppercase tracking-[0.2em] opacity-80 pl-1 group-hover:text-white transition-colors">Clash Builder</span>
             </div>
          </div>
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-6 gap-4">
                    ...
                    <div className="flex gap-3">
                        ...
                        {deck.length === 8 
                            ...
                            : <span className="opacity-70">{8 - deck.length} {t.cardsCount}</span>}
                        </button>
                    </div>
                </div>
